    ...
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
      ...
      <div class="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse ">
        <div id="navbar-sticky" class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1 mr-4">
          <ul class="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
            <li>
              <router-link :class='route.path === "/" ? activeItem : inactiveItem'
                           aria-current="page"
                           to="/"
              >Home
              </router-link>
            ...
            <li>
              <a :class="inactiveItem" href="https://denchic45.github.io/Studiversity/"
                 target="_blank">Документация</a>
            </li>
            <li>
              <a :class="inactiveItem" href="https://github.com/denchic45/Studiversity"
